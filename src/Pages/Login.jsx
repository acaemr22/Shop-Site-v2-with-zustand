    ...
    <main className="py-28 pb-48 px-6 bg-slate-100">
      ...
      <Form replace method="POST" className="space-y-12 flex flex-col  items-center">
        ...
        <div className="relative mt-5">
              <input id="password" name="password" type="password" className="peer h-10  bg-slate-100 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none focus:border-sky-500" placeholder=" " />
